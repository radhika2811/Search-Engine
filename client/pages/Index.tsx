      ...
      const mockResults: SearchResult[] = [
        {
          id: "1",
          content:
            "Machine learning algorithms can significantly improve document retrieval by understanding semantic relationships between concepts...",
          similarity: 0.94,
        ...
        },
        {
          id: "2",
          content:
            "Neural networks excel at processing natural language queries and finding contextually relevant information...",
          similarity: 0.89,
        ...
        },
        {
          id: "3",
          content:
            "Vector embeddings capture semantic meaning better than traditional keyword matching approaches...",
          similarity: 0.85,
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-12">
              ...
              understands context, not just words, delivering the most relevant
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge
                            variant={
                              result.similarity > 0.9 ? "default" : "secondary"
                            }
                            className={
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Traditional keyword search finds words. We find meaning.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-brand-200 hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Our neural models understand relationships between concepts,
            ...
            <Card className="border-brand-200 hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Upload PDFs, text files, CSVs, JSON, and databases. We extract
            ...
            <Card className="border-brand-200 hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  FAISS vector indexing delivers sub-second search results
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400">
            Powered by SentenceTransformers, FAISS, and cutting-edge NLP
            research.
          </p>
        </div>
      </footer>
